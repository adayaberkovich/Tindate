...
(lib.datingissues1 = function(mode,startPosition,loop) {
	...
	this.frame_1 = function() {
		playSound("HaddawayWhatIsLoveOfficialmp3cutnet1");
	}
	...
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(2,1,1).p("AEN8TQSHihQPChQCLMGiLLmQxLCzxLizQidr2Cdr2gEAr1gAfIA8QWIAARLEgmegcWQSHiiQPCiQCLMFiLLmQxLC0xLi0Qidr2Cdr1gEgswAP7UAswAEbAsxgEfEgswgAiUAsTgEcAsSAEfEApqghBMACLAgi");
	this.shape_11.setTransform(287.9,207.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#B79999").s().p("EgswAR5IAAxHIAAwdUAsTgEcAsSAEfIA8QXIgdACIgKABIgOACIgEAAQ2ECL2CAAIAAAAIAAAAQ2RAA2RiNQWRCNWRAAIAAAAIAAAAQWCAAWEiLIAEAAIAOgCIAKgBIAdgCIAARKg");
	...
	// in love
	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#000000").ss(2,1,1).p("");
	this.shape_23.setTransform(285.3,196.3);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	// mirorr
	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFCC99").s().p("");
	this.shape_28.setTransform(210.4,267.2);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#FFFF33").s().p("");
	...
	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#FF3366").s().p("");
	this.shape_31.setTransform(219.5,69.9);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#FFFF33").s().p("");
	this.shape_36.setTransform(203.5,148.3);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#FFCC99").s().p("");
	...
	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#FF3366").s().p("");
	this.shape_39.setTransform(218.3,68.8);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#FFFF33").s().p("");
	this.shape_44.setTransform(203.7,149.5);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("#FFCC99").s().p("");
	...
	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("#FF3366").s().p("");
	...
	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("#FFCC99").s().p("");
	this.shape_53.setTransform(206.7,269);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#FFFF33").s().p("");
	...
	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#FF3366").s().p("");
	...
	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#FFCC99").s().p("");
	this.shape_63.setTransform(206.1,271.8);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#FFFF33").s().p("");
	...
	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#FF3366").s().p("");
	this.shape_66.setTransform(214.7,71.6);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f().s("#000000").ss(1,1,1).p("AhZAVIgWgkAgxAdIAYgwABTAYIAdgZAA+AQIAAgpAAhAUIgXgoAhIAUIAAgw");
	...
	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f().s("#000000").ss(2,1,1).p("");
	...
	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#FFCC99").s().p("");
	this.shape_73.setTransform(206.4,274.8);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#FFFF33").s().p("");
	...
	this.shape_80.graphics.f("#FFFFFF").s().p("AqSDHIAIkNIFhiOIAWgIQBKBIBpATIhOBbIh7iuIB7CuIBOhbIBJBbIBdiwIHFA9ICICXIhaCdIg6guQAMg5AKhLQighFheBBQAIBEAKA2IAAADIAAABQAHAlAJAfQl0ATlKAjIgBAAgAhgiBQBegbA0g9IAUADIhdCwgABGjWg");
	...
	this.shape_85.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_87.graphics.f("#FFFFFF").s().p("");
	...
	this.shape_92.graphics.f("#FFFFFF").s().p("AqSDHIAIkNIFhiOIAWgIQBKBIBpATQBegbA0g9IAUADIhdCwIhJhbIhOBbIh7iuIB7CuIBOhbIBJBbIBdiwIHFA9ICICXIhaCdIg6guQAMg5AKhLQighFheBBQAIBEAKA2IAAADIAAABQAHAlAJAfQl0ATlKAjIgBAAg");
	...
	this.shape_95.graphics.f().s("#000000").ss(1,1,1).p("");
	...
	this.shape_99.graphics.f("#FFCC99").s().p("");
	this.shape_99.setTransform(213.2,126.4);

	this.shape_100 = new cjs.Shape();
	this.shape_100.graphics.f("#FFFFFF").s().p("ApaDHIAIkNIFiiOIAVgIQBKBIBpATQBegbA1g9IAUADIheCwIhJhbIhOBbIh6iuIB6CuIBOhbIBJBbIBeiwIFdA9IAUBkQhggThAAtQAHBEAKA2IABADIAAABQAFAaBeASIhIAYQm1AYkVAeIgBAAgAJaCcIABAAIAAABg");
	...
	this.shape_102.graphics.f("#000033").s().p("");
	this.shape_102.setTransform(282.4,202.3);

	this.shape_103 = new cjs.Shape();
	this.shape_103.graphics.f("#773300").s().p("");
	this.shape_103.setTransform(259.6,243.8);

	this.shape_104 = new cjs.Shape();
	this.shape_104.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_104.setTransform(282.4,202.3);

	this.shape_105 = new cjs.Shape();
	this.shape_105.graphics.f("#FFFFFF").s().p("ApaI3IAIkOIFiiNIAVgJQBKBJBpASQBegaA1g9IAUADIheCwIhJhcIhOBcIh6iuIB6CuIBOhcIBJBcIBeiwIFdA9IAUBkQhggThAAtQAHBFAKA2IABADIAAABQAFAZBeATIhIAYQm1AYkVAeIgBAAgAJaINIABAAIAAAAgAH7oHQgMgMAAgRQAAgRAMgMQAMgMARAAQARAAAMAMQAMAMAAARQAAARgMAMQgMAMgRAAQgRAAgMgMg");
	this.shape_105.setTransform(128.9,144);

	this.shape_106 = new cjs.Shape();
	this.shape_106.graphics.f("#000033").s().p("");
	this.shape_106.setTransform(282.4,202.3);

	this.shape_107 = new cjs.Shape();
	this.shape_107.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_107.setTransform(282.4,202.3);

	this.shape_108 = new cjs.Shape();
	this.shape_108.graphics.f("#FFFFFF").s().p("");
	this.shape_108.setTransform(136,138.4);

	this.shape_109 = new cjs.Shape();
	this.shape_109.graphics.f("#000033").s().p("");
	this.shape_109.setTransform(282.4,202.3);

	this.shape_110 = new cjs.Shape();
	this.shape_110.graphics.f().s("#000000").ss(1,1,1).p("");
	this.shape_110.setTransform(282.4,202.3);

	this.shape_111 = new cjs.Shape();
	this.shape_111.graphics.f("#FFFFFF").s().p("");
	this.shape_111.setTransform(166.5,117.8);

	this.shape_112 = new cjs.Shape();
	this.shape_112.graphics.f("#000033").s().p("");
	...
	this.shape_130.graphics.f().s("#000000").ss(2,1,1).p("AEN8TQSHihQPChQCLMGiLLmQxLCzxLizQidr2Cdr2gEAr1gAfIA8QWIAARLEgmegcWQSHiiQPCiQCLMFiLLmQxLC0xLi0Qidr2Cdr1gEgswAP7UAswAEbAsxgEfEgswgAiUAsTgEcAsSAEfEApqghBMACLAgi");
	this.shape_130.setTransform(287.9,207.9);

	this.shape_131 = new cjs.Shape();
	this.shape_131.graphics.f().s("#000000").ss(1,1,1).p("AA1AsIAgAhAhUhMIBvB4");
	this.shape_131.setTransform(455.8,483);

	this.shape_132 = new cjs.Shape();
	this.shape_132.graphics.f("#B79999").s().p("EgswAR5IAAxHIAAwdUAsTgEcAsSAEfIA8QXIgdACIgKABIgOACIgEAAQ2ECL2CAAIAAAAIAAAAQ2RAA2RiNQWRCNWRAAIAAAAIAAAAQWCAAWEiLIAEAAIAOgCIAKgBIAdgCIAARKg");
